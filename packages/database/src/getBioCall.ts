...
export async function getBioCall(id: string): Promise<BioCallRecord | null> {
  ...
  const data: BioCall = {
    personalData: {
      ...
      segundoNombre: nullToEmpty(pd.segundoNombre),
    ...
    family: {
      ...
      segundoNombreConyuge: nullToEmpty(fam?.segundoNombreConyuge),
      ...
      fechaMatrimonioConyuge: nullToEmpty(fam?.fechaMatrimonioConyuge),
      lugarMatrimonioConyuge: nullToEmpty(fam?.lugarMatrimonioConyuge),
      fechaNacimientoConyuge: nullToEmpty(fam?.fechaNacimientoConyuge),
      lugarNacimientoConyuge: nullToEmpty(fam?.lugarNacimientoConyuge),
      nombresPadre: padre.nombres,
      segundoNombrePadre: nullToEmpty(fam?.segundoNombrePadre),
      apellidoPaternoPadre: padre.apellidoPaterno,
      apellidoMaternoPadre: padre.apellidoMaterno,
      nombresMadre: madre.nombres,
      segundoNombreMadre: nullToEmpty(fam?.segundoNombreMadre),
      ...
      matrimoniosPrevios: record.previousMarriages.map((item) => {
        ...
        return {
          ...
          segundoNombreExConyuge: nullToEmpty(item.segundoNombreExConyuge),
      ...
      hijos: record.children.map((item) => {
        ...
        return {
          ...
          segundoNombre: nullToEmpty(item.segundoNombre),
