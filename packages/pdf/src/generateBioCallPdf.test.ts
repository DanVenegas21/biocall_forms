...
describe("generateBioCallPdf", () => {
  ...
  it("incluye datos clave del cliente bc_001", async () => {
    ...
    expect(text).toContain("¿Cuál es el primer nombre del hijo 1 del cliente?");
    expect(text).toContain("¿Cuál es el apellido paterno del hijo 1 del cliente?");
    expect(text).toContain("Plantilla v2.0");
    expect(text).toContain("¿Cuál es el primer nombre del padre del cliente?");
    expect(text).toContain("¿Cuál es el primer nombre del cliente?");
